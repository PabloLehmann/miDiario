        ...
        <form action="noticias_editar_guardar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="copete" name="copete" placeholder="Ingrese un copete"
                    required value="<?php print($resultado['copete']); ?>">

            </div>
            <div class="mb-3">
                <label for="cuerpo" class="form-label">Cuerpo</label>
                <textarea class="form-control" rows="10" id="cuerpo" name="cuerpo"
            ...
            <div class="mb-3">
                ...
                <img src="../imagenes_subidas/<?php print($resultado['imagen']); ?> " width="80px" height="80px">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="categoria" name="categoria" required>
                    ...
                    <option value="Sociales" <?php if ($resultado['categoria'] == "Sociales")
                        print("selected"); ?>>Sociales
                    </option>
                </select>
            </div><div class="mb-3">
                <label for="autor" class="form-label">Autor</label>
                <input type="text" class="form-control" id="autor" name="autor" placeholder="Ingrese un autor"
                    required value="<?php print($resultado['autor']); ?>">
            ...
            <div class="mb-3">
                ...
                <a href="noticias.php" class="btn btn-info">Volver a Noticias</a>
            </div>
        </form>
    </div>
    <div id="librerias">
